                                    ...
                                    <div className="flex items-start gap-2 sm:gap-4">
                                        ...
                                        <div className="">
                                            ...
                                            <p className="mt-2 sm:mt-4 text-xs sm:text-sm/relaxed ">
                                                ...
                                                passports ranging from 2 years
                                                back. you can take advantage
                                                this information to get your
                                                passport.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                >
                                    <div className="flex items-start gap-2 sm:gap-4">
                                        ...
                                        <div className="">
                                            ...
                                            <p className="mt-2 sm:mt-4 text-xs sm:text-sm/relaxed ">
                                                From Cities Like : Addis Ababa, Dire
                                                Dawa, Adama, Hawassa, Jimma,
                                                Bahir Dar, Jijiga, Mekele,
                                                Dessie, Asosa, Semera, Hosaena,
                                                Gambela
                                            </p>
                                        </div>
                                    </div>
