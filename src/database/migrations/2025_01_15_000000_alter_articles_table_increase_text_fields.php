...
return new class extends Migration {
    ...
    {
        // Only alter the table if it exists (for production environments)
        // In fresh installs, the create_articles migration already has correct column types
